      ...
      <div class="card">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <a href="http://linuxfromscratch.org/lfs/" target="_blank" class="btn btn-primary">Go to Website</a>
            <br>
            <br>
            <div class="card-footer">
              <br>
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="contact-form">
          ...
          <form method="POST" action="https://formspree.io/soumyacool2012@gmail.com">
